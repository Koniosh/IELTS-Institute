...
const Footer = () => {
  return (
    <footer
      id="contact"
      className="bg-gradient-to-br from-dark via-gray-900 to-dark text-white py-20 relative overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 mb-12">
          <div className="lg:col-span-1">
            <h3 className="text-3xl font-bold font-display mb-6">
              IELTS<span className="gradient-text">Pro</span>
            </h3>
            <p className="text-gray-400 mb-6">
              Your AI-powered companion for IELTS success. Join thousands of
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["About Us", "Courses", "Pricing", "Blog", "Careers"].map(
                (link) => (
                  <li key={link}>
                    <a
                      href="#"
              ...
              <div className="mt-6">
                ...
                <div className="flex">
                  <input
                    ...
                    className="flex-1 px-4 py-2 bg-white/10 rounded-l-lg text-white placeholder-gray-500 focus:outline-none focus:bg-white/20 transition-colors"
                  />
                  <button className="px-4 py-2 bg-gradient-to-r from-primary to-secondary rounded-r-lg hover:shadow-lg transition-all duration-300">
                    Subscribe
                  </button>
                </div>
              </div>
        ...
        <div className="border-t border-gray-800 pt-8 mt-12">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 IELTSPro. All rights reserved. Made with ❤️ for IELTS
              students worldwide.
            </p>
